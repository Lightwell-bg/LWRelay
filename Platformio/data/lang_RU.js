var langRU = {
	...
	send1:"Отправить на экран",
	send2:"Отправить на экран",
	//-- index
	P_wifi_title:"НАСТРОЙКА WIFI",
	P_wifi_informer:"Подключение к сети internet позволит синхронизировать время.",
	...
	P_control_title:"КОНТРОЛЬ УСТРОЙСТВА",
	P_on_off:"ON/OF",
    //-- time
    ...
    P_weather_server:"Ресурс, мин",
	P_weather_key:"Отработано, мин",
	...
	P_news_update:"Обновить",
    //-- setup
    P_setup_title:"Настройки",
	P_setup_autoff: "Авто отключение",
	P_setup_peroff:"Время работы",
	P_setup_speed:"Порог освещенности",
	P_setup_writeEPPROM:"Сохранять данные в памяти",
	...
	P_setup_font:"Шрифт",
    //-- led
    P_resource:"Ресурс, часов",
	P_worked_out:"Отработано, часов",
	P_lamp_remaining:"Оставшийся ресурс лампы, часов",
	P_led_set:"Расписание",
	...
	P_GPSVal:"Значение",
        //-- mqtt
	P_sensor_Correct:"Коррекция температуры",
	P_sensor_unit:"Передавать давление на MQTT и сервер в",
	P_sensor_set:"Использовать датчик температуры для контроля",
	P_sensor_On:"Включить",
	P_sensor_ctype:"Control type",
	P_sensor_val:"Temperature",
	P_sensor_gister:"Precision",
    P_mqtt_title:"Настройка датчиков",
	...
	P_mqtt_sub_relay:"Топик включения реле",
